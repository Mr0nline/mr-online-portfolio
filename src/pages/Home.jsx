...
const Model = () => {
  const gltf = useLoader(GLTFLoader, require("../assets/ramen_house_2.glb"));
  return (
    <>
      <primitive object={gltf.scene} scale={0.04} position={[0, 2, 0]} rotation={[-Math.PI / 180, 0, 0]}/>
    </>
  );
};
...
const Home = (props) => {
  return (
    <Canvas
      ...
      <EffectComposer>
        <DepthOfField focusDistance={0} focalLength={0.25} bokehScale={0.75} height={480}/>
